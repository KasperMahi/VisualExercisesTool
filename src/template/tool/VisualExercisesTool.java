...
public class VisualExercisesTool implements Tool, ActionListener {
  Base base;
  WFrame currentFrame;
  JButton tryitButton;
  ...
  public String getMenuTitle() {
	  //This is the name in processing's menu
    return "Visual Exercises";
  }
  ...
  public void run() {
    createWalkthrough();
    System.out.println("Visual Exercises 1.0.0");
...
//				"}\n";
	  String aniEllipse = "ellipse(75, 0, 80, 80);";
	  tutorialCode.put(3, aniEllipse);
	  
	  String setupDraw = "void setup() {"+"\n" + 
	  		"  //Your code here\n" + 
	  		"}\n" + 
	  		"\n" + 
	  		"void draw() {"+"\n" + 
	  		"  //Your code here\n" + 
	  		"}\n";
  		tutorialCode.put(4, setupDraw);
  		
  	  String ex2 = "float var = 0.0;\n" + 
  	  		"\n" + 
  	  		"void setup() {\n" + 
  	  		"  size(500, 500);\n" + 
  	  		"}\n" + 
  	  		...
  	  		"void draw() {\n" + 
  	  		"  var = var + 1.0;\n" + 
  	  		"  ellipse(250, 250, var, var);\n" + 
  	  		"}";
	  tutorialCode.put(6, ex2);
	  
  	  String ex3 = "void setup() {\n" + 
  	  		"  size(500, 500);\n" + 
  	  		"}\n" + 
  	  		"\n" + 
  	  		"void draw() {\n" + 
  	  		...
  	  		"}";
  	  tutorialCode.put(8, ex3);
	  
  	  
  	  String ex4 = "int xPos = 0;\n" + 
  	  		"\n" + 
  	  		"void setup() {\n" + 
  	  		"  size(500, 500);\n" + 
  	  		"}\n" + 
    	  ...
    	  tutorialCode.put(11, ex4);
      	  ...
      	  String ex5 = "\n" + 
      	  		...
      	  		"    CreateCircle(255,0,0);\n" + 
      	  		"    CreateCircle(0,255,0);\n" + 
      	  		"    CreateCircle(0,0,255);\n" + 
      	  		"  }\n" + 
      	  		"}\n" + 
      	  		"\n" + 
      	  		"void CreateCircle(int red, int green, int blue) {\n" + 
      	  		"  circle(random(500), random(500), random(100));\n" + 
      	  		"  fill(random(red),random(green),random(blue));\n" + 
      	  		"  noStroke();\n" + 
      	  		"}";
          	  tutorialCode.put(14, ex5);
...
//	  tutorialCode.put(10, idErrors);
  ...
  public void actionPerformed(ActionEvent e) {
		...
		if(selected.equals("Previous")) {
			...
			if(pos == 1 || pos == 3 || pos == 4 || pos == 6 || pos == 8 || pos == 11 || pos == 14) {
